...
//
// 20개 상황판(집, 병원, 식당, 학교 등) 수동 선택
// ========================================

import { useCallback } from 'react';
import { SITUATION_BOARDS } from '../../../domains/situation/data/situations.ts';
import type { SituationId, SituationCard } from '../../../domains/situation/models.ts';
import type { Card } from '../../../domains/card/models.ts';
import { useSituationStore } from '../../../domains/situation/store/useSituationStore.ts';
...
export default function SituationScreen() {
  ...
  const activeSituation = useSituationStore((s) => s.activeSituation);
  const setActiveSituation = useSituationStore((s) => s.setActiveSituation);
