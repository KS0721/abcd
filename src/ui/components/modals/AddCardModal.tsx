...
import { normalizeKeyword } from '../../../domains/sentence/services/grammarService.ts';
...
export default function AddCardModal() {
  const { isOpen, category } = useUIStore((s) => s.addCardModal);
  const closeAddCardModal = useUIStore((s) => s.closeAddCardModal);
  const addUserCard = useCardStore((s) => s.addUserCard);
  ...
  return (
    <div className={styles.overlay} onClick={handleClose}>
      <div className={styles.addCardModal} onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-label="카드 추가">
