...
export default function EditCardModal() {
  const { isOpen, card, category } = useUIStore((s) => s.editCardModal);
  const closeEditCardModal = useUIStore((s) => s.closeEditCardModal);
  const updateUserCard = useCardStore((s) => s.updateUserCard);
  ...
  return (
    <div className={styles.overlay} onClick={() => closeEditCardModal()}>
      <div className={styles.addCardModal} onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-label="카드 수정">
